...
defaultSwitchList.push(
    new KbSwitch(
        ...
        true,
        5,
        "Otro switch frutal de la mano de C³Equalz",
...
defaultSwitchList.push(
    new KbSwitch(
        ...
        true,
        5,
        "Con su nuevo difuminador de rgb podrás aprovechar al máximo la iluminación de tus Leds",
...
defaultSwitchList.push(
    new KbSwitch(
        ...
        true,
        5,
        "Ideales para la oficina, puede requerir un lubeo superficial",
...
defaultSwitchList.push(
    new KbSwitch(
        ...
        false,
        5,
        "Vuelven los pandas, esta vez por Tecsee. Calidad y estética inconfundibles",
